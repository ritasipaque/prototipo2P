...
public class dos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Ingrese el codigo del maestro :");
        ...
        jLabel11.setText("codigo maestro:");
        ...
        jLabel4.setText("Estatus del maestro:");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel2.setText("Email del maestro:");

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel6.setText("Telefono del maestro");

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel8.setText("Direccion del maestro");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                txt_1.setText(rs.getString("Codigo_Maestros"));
                txt_2.setText(rs.getString("nombre_Maestros"));
                txt_3.setText(rs.getString("Estatus_Maestros"));
                txt_4.setText(rs.getString("direccion_Maestros"));
                txt_5.setText(rs.getString("telefono_Maestros"));
                txt_6.setText(rs.getString("Email_Maestros"));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/bd_9959193293", "root", "");
            PreparedStatement pst = cn.prepareStatement("update alumnos set Codigo_Maestros  = ?, nombre_Maestros  = ?, Estatus_Maestros  = ?, direccion_Maestros = ?, telefono_Maestros = ?, Email_Maestros  = ?    where ID = " + ID);
