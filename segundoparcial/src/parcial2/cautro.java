 ...
 */
public class cautro extends javax.swing.JInternalFrame {

    /**
     * Creates new form cautro
     */
    public cautro() {
        initComponents();
    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("update sedes set Codig_Sedes = ? , nombre_Sedes =? , Estatus_Sedes = ?  where ID = " + ID);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                ...
                txt_1.setText(rs.getString("codigo_Sedes"));
                txt_2.setText(rs.getString("nombre_Sedes"));
                txt_3.setText(rs.getString("Estatus_Sedes"));
